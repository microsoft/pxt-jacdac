namespace modules {
    ...
    export class RotaryEncoderClient extends jacdac.SimpleSensorClient {
        ...
        constructor(role: string) {
            ...
            this._clicksPerTurn = this.addRegister<[number]>(jacdac.RotaryEncoderReg.ClicksPerTurn, jacdac.RotaryEncoderRegPack.ClicksPerTurn, jacdac.RegisterClientFlags.Const)
            this._clicker = this.addRegister<[boolean]>(jacdac.RotaryEncoderReg.Clicker, jacdac.RotaryEncoderRegPack.Clicker, jacdac.RegisterClientFlags.Optional | jacdac.RegisterClientFlags.Const)            
        }
