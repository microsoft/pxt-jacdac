namespace modules {
    ...
    export class CapacitiveButtonClient extends jacdac.Client {
        ...
        constructor(role: string) {
            ...
            this._threshold = this.addRegister<[number]>(jacdac.CapacitiveButtonReg.Threshold, jacdac.CapacitiveButtonRegPack.Threshold)            
        }
    ...
    //% fixedInstance whenUsed weight=1 block="capacitive button1"
