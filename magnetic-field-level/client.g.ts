namespace modules {
    ...
    export class MagneticFieldLevelClient extends jacdac.SimpleSensorClient {
        ...
        private readonly _variant : jacdac.RegisterClient<[jacdac.MagneticFieldLevelVariant]>;            

        constructor(role: string) {
            super(jacdac.SRV_MAGNETIC_FIELD_LEVEL, role, jacdac.MagneticFieldLevelRegPack.Strength)

            this._variant = this.addRegister<[jacdac.MagneticFieldLevelVariant]>(jacdac.MagneticFieldLevelReg.Variant, jacdac.MagneticFieldLevelRegPack.Variant, jacdac.RegisterClientFlags.Optional | jacdac.RegisterClientFlags.Const)            
        }
    ...
    export const magneticFieldLevel1 = new MagneticFieldLevelClient("magnetic Field Level1");
}