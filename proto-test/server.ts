namespace jacdac {
    export class ProtoTestServer extends Server {
        ...
        handlePacket(pkt: JDPacket) {
            ...
            this.bool = this.handleRegBool(
                pkt,
                jacdac.ProtoTestReg.RwBool,
                this.bool
            )
            this.handleRegBool(pkt, jacdac.ProtoTestReg.RoBool, this.bool)

            this.i32 = this.handleRegInt32(
                pkt,
                jacdac.ProtoTestReg.RwI32,
                this.i32
            )
            this.handleRegInt32(pkt, jacdac.ProtoTestReg.RoI32, this.i32)

            this.u32 = this.handleRegUInt32(
                pkt,
                jacdac.ProtoTestReg.RwU32,
                this.u32
            )
            this.handleRegUInt32(pkt, jacdac.ProtoTestReg.RoU32, this.u32)

            this.s = this.handleRegValue(
                pkt,
                jacdac.ProtoTestReg.RwString,
                "s",
                this.s
            )
            this.handleRegValue(pkt, jacdac.ProtoTestReg.RoString, "s", this.s)

            this.bytes = this.handleRegValue(
                pkt,
                jacdac.ProtoTestReg.RwBytes,
                "b",
                this.bytes
            )
            this.handleRegValue(
                pkt,
                jacdac.ProtoTestReg.RoBytes,
                "b",
                this.bytes
            )

            this.i8u8u16i32 = this.handleRegFormat<number[]>(
                pkt,
                jacdac.ProtoTestReg.RwI8U8U16I32,
                "i8 u8 u16 i32",
                this.i8u8u16i32
            )
            this.handleRegFormat<number[]>(
                pkt,
                jacdac.ProtoTestReg.RoI8U8U16I32,
                "i8 u8 u16 i32",
                this.i8u8u16i32
            )
